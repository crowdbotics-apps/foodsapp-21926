"""foodsapp_21926 URL Configuration
...
admin.site.site_header = "FoodsApp"
admin.site.site_title = "FoodsApp Admin Portal"
admin.site.index_title = "FoodsApp Admin"

# swagger
api_info = openapi.Info(
    title="FoodsApp API",
    default_version="v1",
    description="API documentation for FoodsApp App",
)
